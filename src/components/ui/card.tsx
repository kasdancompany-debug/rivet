...
function Card({
  ...
  size?: "default" | "sm"
  /** default: standard surface. quiet: flatter, less chrome. inset: sits inside another panel. */
  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "default" && "rivet-panel has-data-[slot=card-footer]:rounded-b-xl",
        variant === "quiet" &&
          "border border-border/50 bg-card shadow-none has-data-[slot=card-footer]:rounded-b-xl",
        variant === "inset" &&
          "border border-border/40 bg-muted/20 shadow-none has-data-[slot=card-footer]:rounded-b-xl dark:bg-muted/15",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-xl border-t border-border/40 bg-muted/15 p-4 group-data-[size=sm]/card:p-4 dark:bg-muted/10",
        className
      )}
      {...props}
    />
