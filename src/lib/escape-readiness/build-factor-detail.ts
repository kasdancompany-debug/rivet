...
const FACTOR_DETAILS: Record<EscapeReadinessFactorId, FactorDetailTemplate> = {
  sop_coverage: {
    complete: {
      ...
      strong: ["SOP depth across active plays", "Roles and evidence on critical procedures", "Refresh cadence on key plays"],
    },
    missing: {
      empty: ["Active open and close procedures", "Documented steps on highest-variance plays", "Named owners on published SOPs"],
      critical: ["Written open and close playbooks", "Steps on your most repeated questions", "Owner assigned on each critical SOP"],
      fragile: ["Depth on high-variance procedures", "Evidence and refresh dates on key plays", "Coverage for rush-week scenarios"],
      building: ["Full depth on edge-case procedures", "Backup owners when primary is out", "One-page summaries for floor staff"],
      strong: ["Quarterly refresh on all critical plays", "Cross-training links on every SOP"],
    },
    suggestedAction: {
      empty: "Publish open, close, and one high-variance play with steps and a named owner.",
      critical: "Document open, close, and the procedure you explain most often—one page each.",
      fragile: "Add steps, roles, and evidence to your top three variance procedures.",
      building: "Deepen your thinnest active SOP and assign a backup owner.",
      strong: "Schedule refresh on your oldest critical play and tie it to training.",
    },
    fixCta: { label: "Publish an SOP now", href: "/sops/new" },
  },
  training_coverage: {
    complete: {
      empty: [],
      ...
      strong: ["High completion on critical modules", "Training tied to published SOPs", "New hires get a clear path"],
    },
    missing: {
      empty: ["Training assignments for floor roles", "Modules linked to real procedures", "Completion dates with accountability"],
      critical: ["Assigned modules for open and close", "Completion tracking on critical tasks", "Training tied to SOPs—not shadowing"],
    ...
    suggestedAction: {
      ...
      fragile: "Link an existing module to the SOP staff ask about most—and require completion.",
  ...
  unresolved_issues: {
    complete: {
      ...
      strong: ["No stale unresolved issues", "Owners on every open item", "Fixes linked to SOPs or training"],
    },
    missing: {
      ...
      fragile: ["Resolution path on repeat mistakes", "Fewer than three stale open issues", "Link to SOP or training fix"],
    ...
    suggestedAction: {
      ...
      building: "Link the top open issue to an SOP fix or training module.",
  ...
  owner_interruptions: {
    complete: {
      ...
      strong: ["Low interrupt volume logged", "Staff use SOPs before escalating", "Clear escalation path without owner"],
    },
    missing: {
      ...
      fragile: ["Trend visible over 14 days", "SOP for top interrupt category", "Staff trained on when not to escalate"],
    ...
    suggestedAction: {
      ...
      fragile: "Turn your top interrupt category into an SOP with a named backup.",
